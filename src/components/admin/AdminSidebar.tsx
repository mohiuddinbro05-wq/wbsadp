...
const menuSections: MenuSection[] = [
  {
    ...
    items: [
      ...
      { title: "Withdrawals", icon: TrendingDown, path: "/admin/withdrawals", badge: 23 },
      { title: "Deposits", icon: TrendingUp, path: "/admin/deposits", badge: 8 },
      { title: "Users", icon: Users, path: "/admin/users" },
      { title: "User Credentials", icon: Key, path: "/admin/user-credentials" },
      { title: "History", icon: History, path: "/admin/history" },
      { title: "Requests", icon: ClipboardList, path: "/admin/requests", badge: 4 },
    ],
  },
  {
    label: "CONTENT",
    items: [
      ...
      { title: "Subscription", icon: Crown, path: "/admin/subscription" },
      {
        title: "Home Page Editor",
        icon: Home,
        subItems: [
          { title: "Hero Section", icon: Image, path: "/admin/editor/hero" },
          { title: "About Section", icon: Type, path: "/admin/editor/about" },
          { title: "Features", icon: Layers, path: "/admin/editor/features" },
          { title: "Testimonials", icon: Star, path: "/admin/editor/testimonials" },
          { title: "FAQ", icon: HelpCircle, path: "/admin/editor/faq" },
          { title: "Contact Info", icon: Phone, path: "/admin/editor/contact" },
        ],
      },
    ],
  },
  {
    ...
    items: [
      { title: "Admin Users", icon: UserCog, path: "/admin/team/admins" },
      { title: "Agents", icon: UserPlus, path: "/admin/team/agents" },
      { title: "Support Team", icon: Headphones, path: "/admin/team/support" },
      { title: "Moderators", icon: UserCheck, path: "/admin/team/moderators" },
    ],
  },
  {
    label: "MANAGEMENT",
    items: [
      { title: "Payment Methods", icon: Wallet, path: "/admin/payment-methods" },
      ...
      { title: "Terms", icon: FileQuestion, path: "/admin/terms" },
    ],
  },
  {
    label: "SYSTEM",
